...
module.exports = {
  ...
  attributes: {
    mid               : {type: 'string', require: true, unique: true},   // 微博的MID
    idstr             : {type: 'string', require: true, unique: true},   // 字符串型的微博ID
    text              : {type: 'string', require: true},   // 微博信息内容
    ...
    reposts_count     : {type: 'integer', require: true, defaultsTo: 0},  // 转发数
    comments_count    : {type: 'integer', require: true, defaultsTo: 0},  // 评论数
