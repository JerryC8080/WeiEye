...
/**
 * @ngdoc function
 * @name adminApp.controller:StatusesCtrl
 * @description
 * # StatusesCtrl
 * Controller of the adminApp
 */
angular.module('adminApp')
  .controller('StatusesCtrl', function ($scope, Status, $http, DS, notify) {
      ...
      function initUsers() {
        ...
        Status.findAll(getParams()).then(function (data) {
          $scope.statuses = data;
        });
      }
